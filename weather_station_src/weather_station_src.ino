...
{
  WiFi.enableSTA(true);
  delay(2000); //wait a moment after config to start WiFi
...
void getWeatherData(void) //client function to send/receive GET request data.
{
  String result ="";
  WiFiClient client;
